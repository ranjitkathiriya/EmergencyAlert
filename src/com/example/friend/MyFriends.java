...
public class MyFriends extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		friendsView = inflater.inflate(R.layout.friends_my_friends_list,
				container, false);
		setContent();
		USERNAME = Typeface.createFromAsset(getActivity().getAssets(),
				"Fonts/USERNAME.TTF");
		linear_friendlist_listview = (LinearLayout) friendsView
		...
		if (StaticData.isNetworkAvailable(getActivity())) {
			...
			friendsView = inflater.inflate(R.layout.global_internet_not_found,
					container, false);
		}
	...
	private void setContent() {
		// TODO Auto-generated method stub
		lv_friendlist = (ListView) friendsView.findViewById(R.id.lv_friendlist);
		empty = (TextView) friendsView.findViewById(R.id.empty);
		empty.setVisibility(View.GONE);

		linear_friendlist_listview = (LinearLayout) friendsView
				.findViewById(R.id.linear_friendlist_listview);

		btn_find_friend = (Button) friendsView
				.findViewById(R.id.btn_find_friend);
		btn_find_friend.setOnClickListener(new OnClickListener() {
	...
	public void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		Log.i("On Resume Friends", "On Resume Friends");
		// if (firstTimeLoad || StaticData.resetMyFriendsFlag) {
		firstTimeLoad = false;
		StaticData.resetMyFriendsFlag = false;
		alist.clear();
		arr_fdetail.clear();
		fillFriendlist();
		// }
	...
	private void fillFriendlist() {
		...
		Log.i("Fill Friend List method", "FriendList method Call");
	...
	private void postData() {
		...
		try {
			...
			String url = StaticData.SERVER_URL + "myfriend.php";
	...
	private void result() {
		...
		if (login_result.equals("1")) {
			...
			// linear_friendlist_listview.setVisibility(View.GONE);
			// relative_friend_not_found.setVisibility(View.VISIBLE);
			// fillist();
	...
	private void fillist() {
		...
		adapter = new SpecialAdapter(getActivity(), alist,
